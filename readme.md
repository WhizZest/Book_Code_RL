...
#### 后续：
相比于其他章节，AlphaZero五子棋项目过于复杂，所以我建了新的仓库，专门用于更新AlphaZero五子棋项目，后续对AlphaZero五子棋的更新都在新仓库进行，这里将不再对AlphaZero进行更新，后续更新详见[AlphaZeroGomoku](https://github.com/WhizZest/AlphaZeroGomoku)